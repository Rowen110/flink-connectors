...
public class ClickHouseStatementFactory {
    ...
    public static String getReplacingInsert(
            String tableName, String[] fieldNames, Optional<String> replacingField) {
        String columns =
                Arrays.stream(fieldNames)
                        .map(ClickHouseStatementFactory::quoteIdentifier)
                        .collect(Collectors.joining(", "));
    ...
    public static String getCollapsingInsert(
            String tableName, String[] fieldNames, Optional<String> collapsingField) {
        String columns =
                Arrays.stream(fieldNames)
                        .map(ClickHouseStatementFactory::quoteIdentifier)
                        .collect(Collectors.joining(", "));
    ...
    public static String getUpdateStatement(
        ...
        String setClause =
                Arrays.stream(fieldNames)
                        .filter((fieldName) -> !conditionList.contains(fieldName))
