...
public class ClickHouseOptions implements Serializable {
    ...
    private ClickHouseOptions(String url, String username, String password, String clusterName, String databaseName, String tableName, String tableCollapsingField, int batchSize, Duration flushInterval, int maxRetires, boolean writeLocal, String writeLocalNodes, String partitionStrategy, String partitionKey, boolean ignoreDelete) {
        this.url = url;
    ...
    public String toString() {
        return "ClickHouseOptions{url='" + this.url + '\'' + ", databaseName='" + this.databaseName + '\'' + ", tableName='" + this.tableName + '\'' + ", batchSize=" + this.batchSize + ", flushInterval=" + this.flushInterval + ", maxRetries=" + this.maxRetries + ", writeLocal=" + this.writeLocal + ", writeLocalNodes=" + this.writeLocalNodes + ", partitionStrategy='" + this.partitionStrategy + '\'' + ", partitionKey='" + this.partitionKey + '\'' + ", ignoreDelete=" + this.ignoreDelete + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        return (getBatchSize() == options.getBatchSize() &&
                ...
                getWriteLocalNodes() == options.getWriteLocalNodes() &&
    ...
    public int hashCode() {
        return
                Objects.hash(getUrl(), getUsername(), getPassword(), getDatabaseName(), getTableName(),
                        Integer.valueOf(getBatchSize()), getFlushInterval(), Integer.valueOf(getMaxRetries()), Boolean.valueOf(getWriteLocal()),
                        getWriteLocalNodes(),
    ...
    public static class Builder {
        ...
        public ClickHouseOptions build() {
            return new ClickHouseOptions(this.url, this.username, this.password, this.clusterName, this.databaseName, this.tableName, this.tableCollapsingField, this.batchSize, this.flushInterval, this.maxRetries, this.writeLocal, this.writeLocalNodes, this.partitionStrategy, this.partitionKey, this.ignoreDelete);
        }
    }
}