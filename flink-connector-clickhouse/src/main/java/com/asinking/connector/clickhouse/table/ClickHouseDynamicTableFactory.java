...
public class ClickHouseDynamicTableFactory implements DynamicTableSinkFactory {
    ...
    public static final ConfigOption<String> TABLE_COLLAPSING_FIELD =
            ConfigOptions.key("table.collapsing.field")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("Name of the column of the CollapsingMergeTree table");

    public static final ConfigOption<String> TABLE_REPLACING_FIELD =
            ConfigOptions.key("table.replacing.field")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("Name of the column of the ReplacingTree table");
    ...
    public static final ConfigOption<String> SINK_WRITE_LOCAL_NODES =
            ConfigOptions.key("sink.write-local-nodes")
                    .stringType()
                    .noDefaultValue()
                    .withDescription(
    ...
    public Set<ConfigOption<?>> optionalOptions() {
        ...
        optionalOptions.add(TABLE_REPLACING_FIELD);
    ...
    private void validateConfigOptions(ReadableConfig config) {
        ...
        if (!Arrays.asList(
                        ClickHousePartitioner.HASH,
                        ClickHousePartitioner.BALANCED,
                        ClickHousePartitioner.SHUFFLE)
    ...
    private ClickHouseOptions getOptions(ReadableConfig config) {
        return new ClickHouseOptions.Builder()
                ...
                .withClusterName(config.get(CLUSTER_NAME))
                .withDatabaseName(config.get(DATABASE_NAME))
                .withTableName(config.get(TABLE_NAME))
                .withTableCollapsingField(config.get(TABLE_COLLAPSING_FIELD))
                .withTableReplacingField(config.get(TABLE_REPLACING_FIELD))
                ...
                .withWriteLocalNodes(config.get(SINK_WRITE_LOCAL_NODES))
